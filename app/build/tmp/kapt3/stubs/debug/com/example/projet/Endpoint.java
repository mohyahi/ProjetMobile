...
public abstract interface Endpoint {
    ...
    @org.jetbrains.annotations.NotNull()
    @retrofit2.http.GET(value = "getListeTraitant/{phone}")
    public abstract retrofit2.Call<java.util.List<com.example.projet.Medecin>> getListeTraitant(@org.jetbrains.annotations.NotNull()
    @retrofit2.http.Path(value = "phone")
